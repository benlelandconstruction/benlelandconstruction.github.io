...
Email: <a href="mailto:tory@benlelandconstruction.com">tory@benlelandconstruction.com</a></p>
        ...
        <p><h2>Your Message has been sent!</h2><br />
        </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
...
A value is required.</span></span>        <br />
          ...
          <select name="recipient" id="recipient">
            ...
            -->
             <option value="admin@websightprojects.com">Todd</option>
            <option value="brow51@hotmail.com">Marlene</option>
            <option value="mars_barsus@yahoo.com">Tory</option>
